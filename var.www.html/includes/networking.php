<div id="page" hidden>networking</div>
<?php
                  ...
                  foreach($interfaces as $interface) {
					$disabled="";
                      echo '<li role="presentation">'.
                            '<a  '.$disabled.'class="aclick" href="#'.
                                htmlspecialchars($interface, ENT_QUOTES).
								'" aria-controls="'.htmlspecialchars($interface, ENT_QUOTES).
                                '" role="tab" data-toggle="tab">'.htmlspecialchars($interface, ENT_QUOTES).
                                '</a></li>';
                  }
                ?>
              </ul>
...
<?php
                  foreach($interfaces as $interface) {
                     ...
                     else
                     {
						$dis="";
                        $offiface=''.
                        '<label class="btn btn-primary ifaceoff">
                          <input  type="radio" name="'.htmlspecialchars($interface, ENT_QUOTES).
                          '-addresstype" id="'.htmlspecialchars($interface, ENT_QUOTES).
                          '-ifaceoff" autocomplete="off">' . _("Off ") . '</label>';
                        }
                      echo '
                            ...
                            <form id="frm-'.htmlspecialchars($interface, ENT_QUOTES).'">
                              <div class="form-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                  <label class="btn btn-primary dhcpon">
                                    <input type="radio" name="'.htmlspecialchars($interface, ENT_QUOTES).
                                    '-addresstype" id="'.htmlspecialchars($interface, ENT_QUOTES).
                                    '-dhcp" autocomplete="off">' . _("DHCP") . '
                                  </label>
                                  <label class="btn btn-primary dhcpoff">
                                    <input  type="radio" name="'.htmlspecialchars($interface, ENT_QUOTES).
                                    '-addresstype" id="'.htmlspecialchars($interface, ENT_QUOTES).
                                    '-static" autocomplete="off">' . _("Static IP") . '
                                  </label>
                                  '.$offiface.'
                                </div><!-- /.btn-group -->
                              ...
                              <div '.$dis.' class="form-group  dhhide">
                                <label for="'.htmlspecialchars($interface, ENT_QUOTES).'-ssid">' . _("SSID (For wlan0)") . '</label>
                                <input '.$dis.' type="text" class="form-control" id="'.htmlspecialchars($interface, ENT_QUOTES).'-ssid" placeholder="">
                              </div>
                              <div '.$dis.' class="form-group dhhide">
                                <label for="'.htmlspecialchars($interface, ENT_QUOTES).'-psk">' . _("SSID Password") . '</label>
                                <input '.$dis.' type="text" class="form-control" id="'.htmlspecialchars($interface, ENT_QUOTES).'-psk" placeholder="">
                              </div>

                              <div class="form-group dhhide">

      ...
      <div class="panel panel-primary"> 
        ...
        <div class="panel-body">
          ...
          <h4><?php echo _("Client settings"); ?></h4>
              ...
              <a href="?page=configure_client" style="padding:10px;float: right;display: block;position: relative;margin-top: -55px;" class="col-md-2 btn btn-info" id="update">Rescan</a>
	        </div> 
